      ...
      <CDropdownMenu className="pt-0" placement="bottom-end">
        ...
        <CDropdownItem href="#">
          <div className="message">
            ...
            <div className="small text-muted text-truncate">
              Aqui vem uma mensagem direta para o usuário atual...
            </div>
          </div>
        </CDropdownItem>
        ...
        <CDropdownItem href="#">
          <div className="message">
            ...
            <div className="text-truncate font-weight-bold">Título da msg</div>
            <div className="small text-muted text-truncate">
        ...
        <CDropdownItem href="#">
          <div className="message">
            ...
            <div>
              <small className="text-muted">Walter White</small>
            ...
            <div className="small text-muted text-truncate">
              Vamos cozinhar o fim de semana inteiro!
            </div>
          </div>
        </CDropdownItem>
